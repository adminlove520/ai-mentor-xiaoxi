...
import 'piccolore';
import { $ as $$BaseLayout, g as getCollection } from '../../chunks/_astro_content_HzC6Entk.mjs';
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": `${post.data.title_en}` }, { "default": async ($$result2) => renderTemplate(_a || (_a = __template([" ", '<article class="post-detail"> <h2> <span class="lang-en">', '</span> <span class="lang-zh">', "</span> </h2> <time>", "</time> ", ' </article> <nav class="post-nav"> ', ' <a href="/ai-mentor-xiaoxi/" class="nav-home"> <span class="lang-en">All posts</span> <span class="lang-zh">\u6240\u6709\u6587\u7AE0</span> </a> ', ' </nav>  <div class="comments"> <script src="https://giscus.app/client.js" data-repo="adminlove520/ai-mentor-xiaoxi" data-repo-id="R_kgDORh6UiA" data-category="Comments" data-category-id="DIC_kwDORh6UiM4C3_B2" data-mapping="pathname" data-strict="0" data-reactions-enabled="1" data-emit-metadata="0" data-input-position="top" data-theme="preferred_color_scheme" data-lang="zh-CN" data-loading="lazy" crossorigin="anonymous" async>\n    <\/script> </div> '])), maybeRenderHead(), post.data.title_en, post.data.title_zh, post.data.date.replace("T", " ").replace(/:\d{2}$/, ""), renderComponent($$result2, "Content", Content, {}), prev ? renderTemplate`<a${addAttribute(`/ai-mentor-xiaoxi/posts/${prev.data.slug || prev.id.replace(/\.md$/, "")}/`, "href")} class="nav-prev"> <span class="nav-label"> <span class="lang-en">← Previous</span> <span class="lang-zh">← 上一篇</span> </span> <span class="lang-en nav-title">${prev.data.title_en}</span> <span class="lang-zh nav-title">${prev.data.title_zh}</span> </a>` : renderTemplate`<span></span>`, next ? renderTemplate`<a${addAttribute(`/ai-mentor-xiaoxi/posts/${next.data.slug || next.id.replace(/\.md$/, "")}/`, "href")} class="nav-next"> <span class="nav-label"> <span class="lang-en">Next →</span> <span class="lang-zh">下一篇 →</span> </span> <span class="lang-en nav-title">${next.data.title_en}</span> <span class="lang-zh nav-title">${next.data.title_zh}</span> </a>` : renderTemplate`<span></span>`) })}`;
