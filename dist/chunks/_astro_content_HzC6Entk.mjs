import { c as createComponent, a as renderTemplate, e as renderSlot, f as renderHead, d as addAttribute, b as createAstro, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, u as unescapeHTML, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent } from './astro/server_BWCp8Abf.mjs';
import 'piccolore';
import 'clsx';
/* empty css                         */
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  <\/script> </body> </html>`])), title, addAttribute(new URL("rss.xml", Astro2.site), "href"), renderHead(), renderSlot($$result, $$slots["default"]));
}, "C:/Users/whoami/.openclaw/workspace/ai-mentor-xiaoxi/src/layouts/BaseLayout.astro", void 0);
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DR1GmEne.mjs');
